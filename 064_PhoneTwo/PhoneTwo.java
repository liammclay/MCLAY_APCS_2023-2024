public class PhoneTwo {
    ...
    public PhoneTwo(String connectionType, int currentCharge, String model, String color, String brand, String size){
    ...
    public String toString(){
        return "The "+brand+" phone ("+color+" "+model+" "+size+") with a "+connectionType+" has "+currentCharge+" charge.";
